        ...
        addMetaPkgButton.setOnClickListener(view -> {
            ...
            adb.setPositiveButton(R.string.InstallAndUpdateButtonText, (dialog, which) -> {
                ...
                try {
                    ...
                    intent.putExtra("com.tean420.kekterm.iInitialCommand", NhPaths.makeTermTitle("Updating") + "apt update && apt install " + sb.toString() + " -y && echo \"(You can close the terminal now)\n\"");
