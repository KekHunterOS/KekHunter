...
import com.team420.kekhunter.RecyclerViewAdapter.NethunterRecyclerViewAdapter;
import com.team420.kekhunter.RecyclerViewAdapter.NethunterRecyclerViewAdapterDeleteItems;
...
import static com.team420.kekhunter.R.id.f_nethunter_action_search;
...
public class NetHunterFragment extends Fragment {
  ...
  private void onAddItemSetup() {
    addButton.setOnClickListener(v -> {
      ...
      readmeButton1.setOnClickListener(view -> {
        MaterialAlertDialogBuilder adb = new MaterialAlertDialogBuilder(context, R.style.DialogStyle);
  ...
  private void onMoveItemSetup() {
    moveButton.setOnClickListener(v -> {
      ...
      final androidx.appcompat.app.AlertDialog adMove = adbMove.create();
