        ...
        if (customCommandsModelList != null) {
          if (customCommandsModelList.get(position).getExecutionMode().equals("interactive")) {
            ...
            if (customCommandsModelList.get(position).getRuntimeEnv().equals("android")) {
              Log.d("Android", "CMD:" + customCommandsModelList.get(position).getCommand());
              run_cmd_android(customCommandsModelList.get(position).getCommand());
            }
            if (customCommandsModelList.get(position).getRuntimeEnv().equals("kali")) {
              Log.d("Kali", "CMD:" + customCommandsModelList.get(position).getCommand());
              run_cmd(customCommandsModelList.get(position).getCommand());
            }
          } else {
