...
public class CopyBootFilesAsyncTask extends AsyncTask<String, String, String>{
    ...
    private void MakeSYSWriteable(){
        ...
        exe.RunAsRoot(new String[]{"mount -o rw,remount /system"});
    }

    private void MakeSYSReadOnly(){
        Log.d(TAG, "Making /system readonly for symlink");
        exe.RunAsRoot(new String[]{"mount -o ro,remount /system"});
    }
    ...
    private void MakeSYSWriteableSAR(){
        Log.d(TAG, "Making / writeable for symlink");
        exe.RunAsRoot(new String[]{"mount -o rw,remount /"});
    }

    private void MakeSYSReadOnlySAR(){
        Log.d(TAG, "Making / readonly for symlink");
