        ...
        searchSearchSploit.post(() -> {
          if (isFeeded) {
            ...
            try {
              ...
              String data = "/data/data/com.team420.kekhunter/files/";
...
class ExploitLoader extends BaseAdapter {
  ...
  private void start(String file) {
    ...
    command[0] = "su -c /data/data/com.team420.kekhunter/files/scripts/bootkali file2hid-file " + file;
    String test = "su -c /data/data/com.team420.kekhunter/files/scripts/bootkali file2hid-file " + file;
    Log.d("Exe:", test);
