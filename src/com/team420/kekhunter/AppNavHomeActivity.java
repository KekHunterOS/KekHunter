...
import com.team420.kekhunter.AsyncTask.CopyBootFilesAsyncTask;
...
import com.team420.kekhunter.utils.PermissionCheck;
...
public class AppNavHomeActivity extends AppCompatActivity implements KaliGPSUpdates.Provider {
  ...
  private void setRootView() {
    ...
    readmeButton.setOnClickListener(view ->
      showLicense()
    );
  ...
  private void changeDrawer(int itemId) {
    ...
    switch (itemId) {
      ...
      case R.id.mitmf_item:
        ...
        break;
      case R.id.vnc_item:
        if (getApplicationContext().getPackageManager().getLaunchIntentForPackage("com.offsec.kex") == null) {
          showWarningDialog("WARNING", "NetHunter KeX is not installed yet, please install from the store!", false);
  ...
  public void showWarningDialog(String title, String message, boolean NeedToExit) {
   MaterialAlertDialogBuilder warningAD = new MaterialAlertDialogBuilder(this, R.style.DialogStyle);
