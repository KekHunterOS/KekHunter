    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        copyBootFilesAsyncTask.setListener(new CopyBootFilesAsyncTask.CopyBootFilesAsyncTaskListener() {
            ...
            public void onAsyncTaskFinished(Object result) {
                ...
                if (getApplicationContext().getPackageManager().getLaunchIntentForPackage("com.team420.kekterm") == null) {
    ...
    private void changeDrawer(int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.mitmf_item:
                ...
                break;
            case R.id.vnc_item:
                if (getApplicationContext().getPackageManager().getLaunchIntentForPackage("com.team420.kekhunter.kex") == null) {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction() != null) {
                switch (intent.getAction()) {
                    case CHECKCOMPAT:
                        showWarningDialog("KekHunter app cannot be run properly",
