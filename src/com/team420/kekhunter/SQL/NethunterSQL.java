...
public class NethunterSQL extends SQLiteOpenHelper {
    ...
    private static final String[][] nethunterData = {
            ...
            {"5", "Nethunter Terminal Status", "[ \"$(pm list packages | grep 'com.team420.kekterm')\" ] && echo \"Nethunter Terminal is installed.\" || echo \"Nethunter Terminal is NOT yet installed.\"", "\\n", "1"},
