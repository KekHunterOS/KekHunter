...
public class CustomCommandsSQL extends SQLiteOpenHelper {
  ...
  private static final String[][] customcommandsData = {
    ...
    {"4", "Start wlan0 in monitor mode",
      "ifconfig wlan0 down; echo 4 > /sys/module/wlan/parameters/con_mode;ifconfig wlan0 up;exit",
      "android", "interactive", "0"},
    {"5", "Stop wlan0 monitor mode",
      "ifconfig wlan0 down; echo 0 > /sys/module/wlan/parameters/con_mode;ifconfig wlan0 up; svc wifi enable;exit",
      "android", "interactive", "0"},
    {"6", "Start wlan1 in monitor mode",
      "ifconfig wlan1 down && iw wlan1 set monitor control && ifconfig wlan1 up;exit",
      "kali", "interactive", "0"}
  };
