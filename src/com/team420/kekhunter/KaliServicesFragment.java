...
import com.team420.kekhunter.RecyclerViewAdapter.KaliServicesRecyclerViewAdapter;
import com.team420.kekhunter.RecyclerViewAdapter.KaliServicesRecyclerViewAdapterDeleteItems;
...
import com.team420.kekhunter.viewmodels.KaliServicesViewModel;
...
public class KaliServicesFragment extends Fragment {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (item.getItemId()) {
      case R.id.f_kaliservices_menu_backupDB:
        ...
        MaterialAlertDialogBuilder adbBackup = new MaterialAlertDialogBuilder(activity, R.style.DialogStyle);
        ...
        adBackup.setOnShowListener(dialog -> {
          ...
          buttonOK.setOnClickListener(v -> {
            ...
            if (returnedResult == null) {
              ...
              dialog.dismiss();
              new MaterialAlertDialogBuilder(context, R.style.DialogStyle).setTitle("Failed to backup the DB.").setMessage(returnedResult).create().show();
            }
            dialog.dismiss();
          });
        });
      ...
      case R.id.f_kaliservices_menu_restoreDB:
        ...
        storedpathEditText.setText(NhPaths.APP_SD_SQLBACKUP_PATH + "/FragmentKaliServices");
        MaterialAlertDialogBuilder adbRestore = new MaterialAlertDialogBuilder(activity, R.style.DialogStyle);
        ...
        adRestore.setOnShowListener(dialog -> {
          ...
          buttonOK.setOnClickListener(v -> {
            ...
            if (returnedResult == null) {
              ...
              dialog.dismiss();
              new MaterialAlertDialogBuilder(context, R.style.DialogStyle).setTitle("Failed to restore the DB.").setMessage(returnedResult).create().show();
            }
            dialog.dismiss();
          });
        });
  ...
  private void onAddItemSetup() {
    addButton.setOnClickListener(v -> {
      ...
      final MaterialCheckBox runOnChrootStartCheckbox = promptViewAdd.findViewById(R.id.f_kaliservices_add_adb_checkbox_runonboot);
      ...
      MaterialAlertDialogBuilder adbAdd = new MaterialAlertDialogBuilder(activity, R.style.DialogStyle);
  ...
  private void onDeleteItemSetup() {
    deleteButton.setOnClickListener(v -> {
      ...
      MaterialAlertDialogBuilder adbDelete = new MaterialAlertDialogBuilder(activity, R.style.DialogStyle);
  ...
  private void onMoveItemSetup() {
    moveButton.setOnClickListener(v -> {
      ...
      MaterialAlertDialogBuilder adbMove = new MaterialAlertDialogBuilder(activity, R.style.DialogStyle);
