...
public class CustomCommandsSQL extends SQLiteOpenHelper {
    ...
    private static final String[][] customcommandsData = {
            ...
            {"5", "Start wlan0 in monitor mode",
                    "ip link set wlan0 down; echo 4 > /sys/module/wlan/parameters/con_mode;ip link set wlan0 up;exit",
                    "kali", "interactive", "0"},
            {"6", "Stop wlan0 monitor mode",
                    "ip link set wlan0 down; echo 0 > /sys/module/wlan/parameters/con_mode;ip link set wlan0 up;exit",
                    "kali", "interactive", "0"},
