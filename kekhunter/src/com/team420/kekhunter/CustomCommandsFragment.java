...
public class CustomCommandsFragment extends Fragment {
  ...
  private void onAddItemSetup() {
    addButton.setOnClickListener(v -> {
      ...
      final MaterialCheckBox runOnBootCheckbox = promptViewAdd.findViewById(R.id.f_customcommands_add_adb_checkbox_runonboot);
      ...
      adDelete.setOnShowListener(dialog -> {
        ...
        buttonDelete.setOnClickListener(v1 -> {
          ...
          for (int i = 0; i < recyclerViewDeleteItem.getChildCount(); i++) {
            ...
            if (viewHolder != null) {
              MaterialCheckBox box = viewHolder.itemView.findViewById(R.id.f_customcommands_recyclerview_dialog_chkbox);
              if (box.isChecked()) {
